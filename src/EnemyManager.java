...
public class EnemyManager {
    ...
    private int createMax =  Game.FPS/4;//moi 2 giay ta them mot con quai
        ...
        if (!needWait) {
            if (waveManager.index_enemy < waveManager.waves.get(waveManager.index_wave).wave.size()) {
                ...
                if (waveManager.waves.get(waveManager.index_wave).wave.get(waveManager.index_enemy) == 1)
                    ...
                    enemies.add(new Reaper(Game.startPoint.get(i).x, Game.startPoint.get(i).y));
            }
            ...
            if (wait < waitMax) {
                ...
                Monster.hpmax *= (1.05+0.008*waveManager.index_wave);
                Reaper.hpmax *= (1.05+0.008*waveManager.index_wave);
                Dragon.hpmax *= (1.05+0.008*waveManager.index_wave);
                Assasin.hpmax *= (1.05+0.008*waveManager.index_wave);
