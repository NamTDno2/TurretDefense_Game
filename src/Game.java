...
public class Game extends Application {
    ...
    private boolean is_double_speed = false;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //setup nút Pause
        ImageView pauseButton = new ImageView("imgbgr/Menu/Scene/pause.png");
        pauseButton.setFitHeight(45);
        pauseButton.setFitWidth(45);
        pauseButton.setX(800);
        pauseButton.setY(0);
        ImageView pauseButton_on_Mouse = new ImageView("imgbgr/Menu/Scene/pause.png");
        pauseButton_on_Mouse.setFitWidth(55);
        pauseButton_on_Mouse.setFitHeight(55);
        pauseButton_on_Mouse.setX(790);
        ...
        // Setup nút x2_speed
        ImageView double_speed = new ImageView("imgbgr/Menu/Scene/x2.png");
        double_speed.setFitHeight(45);
        double_speed.setFitWidth(45);
        double_speed.setX(860);
        double_speed.setY(0);
        ImageView double_speed_on_mouse = new ImageView("imgbgr/Menu/Scene/x2.png");
        double_speed_on_mouse.setFitWidth(55);
        double_speed_on_mouse.setFitHeight(55);
        double_speed_on_mouse.setX(850);
        double_speed_on_mouse.setY(0);
        // khi trỏ chuột đến nút Pause
        double_speed_on_mouse.setVisible(false);
        double_speed.setOnMouseEntered(event -> {
            double_speed.setVisible(false);
            double_speed_on_mouse.setVisible(true);
        });
        double_speed_on_mouse.setOnMouseExited(event -> {
            double_speed.setVisible(true);
            double_speed_on_mouse.setVisible(false);

        });
        double_speed_on_mouse.setOnMouseClicked(event -> {
            try {
        ...
        // Setup nút mute sound
        ImageView soundButton = new ImageView("imgbgr/Menu/Scene/sound.png");
        soundButton.setFitHeight(45);
        soundButton.setFitWidth(45);
        soundButton.setX(920);
        soundButton.setY(0);
        ImageView muteButton = new ImageView("imgbgr/Menu/Scene/mute.png");
        muteButton.setFitHeight(45);
        muteButton.setFitWidth(45);
        muteButton.setX(920);
        muteButton.setY(0);
        ...
        root.getChildren().addAll(canvas,item,pauseButton,pauseButton_on_Mouse,double_speed,double_speed_on_mouse,soundButton,muteButton);
    ...
    private void begin(){
        ...
        Reaper.hpmax = Reaper.hp_default;
